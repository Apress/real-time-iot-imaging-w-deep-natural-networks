...
public class SelectedHaar {
    public static void main(String[] args) throws Exception {
        ...
        Mat cat = Imgcodecs.imread("lemarceldedavid.jpg");

        MatOfRect faces = new MatOfRect();

        cascadeFaceClassifier.detectMultiScale(cat, faces, 1.1, 1, -1, new Size(200, 200));
        cascadeFaceClassifier.detectMultiScale(cat, faces, 2, 1, -1, new Size(300, 300));
        ...
        Imgcodecs.imwrite("marcel_selected_haar.jpg", cat);
